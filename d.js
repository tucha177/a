...
generateUUID = function(t) {
                                                    return void 0 === t && (t = ""),
                                                    "" + CryptoJS.SHA256(t).toString(CryptoJS.enc.Hex).substring(0, 8) + Date.now().toString(16).padStart(12, "0") + CryptoJS.lib.WordArray.random(16).toString(CryptoJS.enc.Hex).substring(0, 12)
                                                };
...
bii = function() {
  ...
  n.externalToken = '30eec455-6e2c-404f-bca1-ed275be1f450';
  n.currencyid = "USD";
...
f = function ()
{
  ...
  n.slotid = "V001";
  n.slotversion = "d.20251031_9";
  n.accessToken = '30eec455-6e2c-404f-bca1-ed275be1f450';
  n.lineCode = "GGPOKEROK";
  n.clientUTC = getUTC;
